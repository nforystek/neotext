...
'                                Set Camera.Player.Rotate = AngleAxisAddition(Camera.Player.Rotate, Camera.Planet.Rotate)
...
'                                Set Camera.Player.Origin = VectorAddition(Camera.Player.Origin, Camera.Planet.Origin)
'                                Set Camera.Player.Absolute.Origin = Camera.Player.Origin
'                                Set Camera.Player.Relative.Origin = Nothing
                                
'                                Set Camera.Player.Rotate = AngleAxisDeduction(Camera.Player.Rotate, Camera.Planet.Rotate)
'                                Set Camera.Player.Absolute.Rotate = Camera.Player.Rotate
'                                Set Camera.Player.Relative.Rotate = Nothing
