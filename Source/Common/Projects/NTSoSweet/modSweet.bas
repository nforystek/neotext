...
Public Sub soSweetPaserPresets()
    ...
    ParserMessages(ParserCodes.Syntax_07) = "Syntax: [color <color>] rains ! !...; rain !; Example: rains & % # 1 a b"
    ...
    ParserMessages(ParserCodes.Syntax_17) = "Syntax: [color <color>] rains ! !...; rain !; Example: rain !"
