Attribute VB_Name = "modCertConst"
Option Explicit
'+---------------------------------------------------------------------------
'
' Microsoft Windows
...
Public Const CRYPT_Y_ONLY As Long = &H1
Public Const CRYPT_SSL2_SLUMMING As Long = &H2
' dwFlags definitions for CryptHashSessionKey
Public Const CRYPT_LITTLE_ENDIAN As Long = &H1
...
Public Const SCHANNEL_MAC_KEY As Long = &H0
Public Const SCHANNEL_ENC_KEY As Long = &H1
'+-------------------------------------------------------------------------
...
'--------------------------------------------------------------------------
Public Const CERT_ENCODING_TYPE_MASK As Long = &HFFFF
Public Const CMSG_ENCODING_TYPE_MASK As Long = &HFFFF0000
Public Const CRYPT_ASN_ENCODING As Long = &H1
Public Const CRYPT_NDR_ENCODING As Long = &H2
Public Const X509_ASN_ENCODING As Long = &H1
Public Const X509_NDR_ENCODING As Long = &H2
Public Const PKCS_7_ASN_ENCODING As Long = &H10000
Public Const PKCS_7_NDR_ENCODING As Long = &H20000
'+-------------------------------------------------------------------------
...
Public Const CERT_UNICODE_ATTR_ERR_INDEX_MASK As Long = &H3F
Public Const CERT_UNICODE_ATTR_ERR_INDEX_SHIFT As Long = 16
Public Const CERT_UNICODE_VALUE_ERR_INDEX_MASK As Long = &HFFFF
...
Public Const CERT_KEY_AGREEMENT_KEY_USAGE As Long = &H8
Public Const CERT_KEY_CERT_SIGN_KEY_USAGE As Long = &H4
Public Const CERT_OFFLINE_CRL_SIGN_KEY_USAGE As Long = &H2
Public Const CERT_CRL_SIGN_KEY_USAGE As Long = &H2
'+-------------------------------------------------------------------------
...
Public Const CERT_ALT_NAME_VALUE_ERR_INDEX_MASK As Long = &HFFFF
...
Public Const CRL_REASON_SUPERSEDED_FLAG As Long = &H8
Public Const CRL_REASON_CESSATION_OF_OPERATION_FLAG As Long = &H4
Public Const CRL_REASON_CERTIFICATE_HOLD_FLAG As Long = &H2
...
Public Const NETSCAPE_SSL_CA_CERT_TYPE As Long = &H4
'+-------------------------------------------------------------------------
...
' Open dwFlags
'--------------------------------------------------------------------------
Public Const CMSG_BARE_CONTENT_FLAG As Long = &H1
Public Const CMSG_LENGTH_ONLY_FLAG As Long = &H2
Public Const CMSG_DETACHED_FLAG As Long = &H4
Public Const CMSG_AUTHENTICATED_ATTRIBUTES_FLAG As Long = &H8
Public Const CMSG_CONTENTS_OCTETS_FLAG As Long = &H10
'+-------------------------------------------------------------------------
...
Public Const CERT_LAST_RESERVED_PROP_ID As Long = &H7FFF
Public Const CERT_FIRST_USER_PROP_ID As Long = &H8000
Public Const CERT_LAST_USER_PROP_ID As Long = &HFFFF
'+-------------------------------------------------------------------------
...
'--------------------------------------------------------------------------
Public Const CERT_SET_KEY_PROV_HANDLE_PROP_ID As Long = &H1
Public Const CERT_SET_KEY_CONTEXT_PROP_ID As Long = &H1
'+-------------------------------------------------------------------------
...
'--------------------------------------------------------------------------
Public Const CERT_STORE_SIGNATURE_FLAG As Long = &H1
Public Const CERT_STORE_TIME_VALIDITY_FLAG As Long = &H2
Public Const CERT_STORE_REVOCATION_FLAG As Long = &H4
Public Const CERT_STORE_NO_CRL_FLAG As Long = &H10000
Public Const CERT_STORE_NO_ISSUER_FLAG As Long = &H20000
'+-------------------------------------------------------------------------
' Certificate Store open/property flags
'--------------------------------------------------------------------------
Public Const CERT_STORE_NO_CRYPT_RELEASE_FLAG As Long = &H1
Public Const CERT_STORE_READONLY_FLAG As Long = &H8000
'+-------------------------------------------------------------------------
...
Public Const CERT_SYSTEM_STORE_LOCATION_MASK As Long = &H30000
Public Const CERT_SYSTEM_STORE_CURRENT_USER As Long = &H10000
Public Const CERT_SYSTEM_STORE_LOCAL_MACHINE As Long = &H20000
'+-------------------------------------------------------------------------
...
'--------------------------------------------------------------------------
Public Const CERT_CLOSE_STORE_FORCE_FLAG As Long = &H1
Public Const CERT_CLOSE_STORE_CHECK_FLAG As Long = &H2
'+-------------------------------------------------------------------------
...
Public Const CERT_NAME_STR_CRLF_FLAG As Long = &H8000000
Public Const CERT_NAME_STR_COMMA_FLAG As Long = &H4000000
'+-------------------------------------------------------------------------
...
' Address Types:
Public Const ADR_TYPE As Long = &H1
Public Const ADR_STYPE As Long = &H2
Public Const ADR_ADDR As Long = &H4
Public Const ADR_USER As Long = &H8
Public Const ADR_AUTH As Long = &H10
Public Const ADR_TIME As Long = &H20
' Transport Types:
...
Public Const EXTENSION_CRITICAL_FLAG As Long = &H1
Public Const EXTENSION_DISABLE_FLAG As Long = &H2
Public Const EXTENSION_POLICY_MASK As Long = &HFFFF
Public Const EXTENSION_ORIGIN_REQUEST As Long = &H10000
Public Const EXTENSION_ORIGIN_POLICY As Long = &H20000
Public Const EXTENSION_ORIGIN_ADMIN As Long = &H30000
Public Const EXTENSION_ORIGIN_SERVER As Long = &H40000
Public Const EXTENSION_ORIGIN_MASK As Long = &HF0000
'+--------------------------------------------------------------------------
' GetProperty/SetProperty Flags:
'
' Choose one Type
Public Const PROPTYPE_LONG As Long = &H1
Public Const PROPTYPE_DATE As Long = &H2
Public Const PROPTYPE_BINARY As Long = &H3
Public Const PROPTYPE_STRING As Long = &H4
Public Const PROPTYPE_ANSI As Long = &H5
Public Const PROPTYPE_MASK As Long = &HFF
' Choose one Caller:
Public Const PROPCALLER_SERVER As Long = &H100
Public Const PROPCALLER_POLICY As Long = &H200
Public Const PROPCALLER_EXIT As Long = &H300
Public Const PROPCALLER_ADMIN As Long = &H400
Public Const PROPCALLER_MASK As Long = &HF00
' Choose one Table:
Public Const PROPTABLE_REQUEST As Long = &H1000
Public Const PROPTABLE_CERTIFICATE As Long = &H2000
Public Const PROPTABLE_EXTENSIONS As Long = &H3000
Public Const PROPTABLE_ATTRIBUTES As Long = &H4000
Public Const PROPTABLE_MASK As Long = &HF000
' Internal use only
Public Const PROPTABLE_EXTENSIONFLAGS As Long = &H10000
Public Const PROPTABLE_EXTENSIONVALUE As Long = &H20000
...
Public Const CIE_OBJECTID As Long = &H1
Public Const CIE_TABLE_EXTENSIONS As Long = &H10
Public Const CIE_TABLE_ATTRIBUTES As Long = &H20
Public Const CIE_TABLE_MASK As Long = &HF0
'+--------------------------------------------------------------------------
'
' Microsoft Windows
'
