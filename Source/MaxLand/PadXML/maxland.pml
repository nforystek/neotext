...
<XML_DIZ_INFO>
	...
	<Program_Info>
		<Program_Name>MaxLand</Program_Name>
		...
		<Program_Release_Status>Active Release</Program_Release_Status>
		...
		<Program_OS_Support>WinME,WinNT,Win2000,Win2003,Win2008,Win2012,Win20013,WinXP,Vista,Win7,Win8,Win8.1</Program_OS_Support>
		<Program_Language>English</Program_Language>
		<Program_Change_Info />
		<Program_Specific_Category>Games</Program_Specific_Category>
		<Program_Category_Class>Games &amp; Entertainment::Strategy &amp; War Games</Program_Category_Class>
		<Program_System_Requirements>2GHz, 1GB RAM, DirectX</Program_System_Requirements>
		<File_Info><File_Size_Bytes>10349904</File_Size_Bytes><File_Size_K>10349</File_Size_K><File_Size_MB>10.3</File_Size_MB></File_Info>
		<Expire_Info>
	...
	<Program_Descriptions>
		<English>
			<Keywords>game, MaxLand, Neotext, DirectX</Keywords>
			<Char_Desc_45>MaxLand is a game of environment challenges.</Char_Desc_45>
			<Char_Desc_80>MaxLand is a game of environment challenges.</Char_Desc_80>
			<Char_Desc_250>MaxLand is a game of environment challenges.  In a desolate unknown land you are the queen of a palace carved into the side of a mountain by chess pieces and must discover Earth, Win, Fire and Water.</Char_Desc_250>
			<Char_Desc_450>MaxLand is a game of environment challenges.  In a desolate unknown land you are the queen of a palace carved into the side of a mountain by chess pieces and must discover Earth, Win, Fire and Water.</Char_Desc_450>
			<Char_Desc_2000>MaxLand is a game of environment challenges.  In a desolate unknown land you are the queen of a palace carved into the side of a mountain by chess pieces and must discover Earth, Win, Fire and Water.</Char_Desc_2000>
		</English>
	</Program_Descriptions>
	<Web_Info>
		<Application_URLs>
			<Application_Info_URL>MaxLand.htm</Application_Info_URL>
			<Application_Order_URL />
			<Application_Screenshot_URL>MaxLand.png</Application_Screenshot_URL>
			<Application_Icon_URL>MaxLand32.png</Application_Icon_URL>
			<Application_XML_File_URL>MaxLand.xml</Application_XML_File_URL>
		</Application_URLs>
		<Download_URLs>
			<Primary_Download_URL>http://www.neotext.org/ipub/apps/binary/MaxLand%20v2.2.0.exe</Primary_Download_URL>
	...
	<Permissions>
		<Distribution_Permissions>Distribute as Expire Ensure.</Distribution_Permissions>
