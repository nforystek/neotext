...
Private Sub Check4_Click()
    ...
    db.dbQuery "UPDATE Settings SET Surface = " & IIf(Check4.Value = 1, "Yes", "No") & " WHERE Username = '" & Replace(GetUserLoginName, "'", "''") & "';"
End Sub
...
Private Sub Check3_Click()
    ...
    db.dbQuery "UPDATE Settings SET SoundFX = " & IIf(Check3.Value = 1, "No", "Yes") & " WHERE Username = '" & Replace(GetUserLoginName, "'", "''") & "';"
End Sub
...
Private Sub Form_Load()
    ...
    If Not db.rsEnd(rs) Then
        ...
        Check4.Value = -CInt(CBool(rs("Surface")))
    Else
        db.dbQuery "INSERT INTO Settings (Username, Resolution, Windowed, Ambient, SoundFX, Surface) VALUES ('" & Replace(GetUserLoginName, "'", "''") & "', '1024x768', Yes, Yes, Yes, No);"
        For cnt = 0 To Combo1.ListCount - 1
