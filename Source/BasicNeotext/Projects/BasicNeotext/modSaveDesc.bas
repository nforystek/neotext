Attribute VB_Name = "modSaveDesc"
Option Explicit

Private Const BEGINS = "' _" & vbCrLf
Private Const MIDDLE1 = vbCrLf & "Attribute "
Private Const MIDDLE2 = ".VB_Description = """
Private Const ENDING = """" & vbCrLf
