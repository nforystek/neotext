...
<PADGEN_PML>
	...
	<CompanyName />
	<Program_Info>
		<Program_Name>Blacklawn</Program_Name>
		...
		<File_Info>
			<File_Size_Bytes>19737424</File_Size_Bytes><File_Size_K>19737</File_Size_K><File_Size_MB>19.7</File_Size_MB>
		</File_Info>
		<Expire_Info>
	...
	<Program_Descriptions>
		<English>
			<Keywords>game, Blacklawn, bee, bot, Neotext, DirectX</Keywords>
			<Char_Desc_45>Blacklawn is a game of unique proportions.</Char_Desc_45>
			<Char_Desc_80>Blacklawn is a game of out of the box thinking, about as basic as it gets.</Char_Desc_80>
			<Char_Desc_250>Blacklawn is a unique game to say the least in innovation of out of the box thinking, it is about as basic as it gets on first sight. No illusion, you start on the lawn (as a winged bot in the XP version). Surrounded by black trial.</Char_Desc_250>
			...
			<Char_Desc_2000>Blacklawn is a unique game to say the least in innovation of out of the box thinking, it is about as basic as it gets on first sight. No illusion, you start on the lawn (as a winged bot in the XP version). Surrounded by black trial, all the info of your abilities and limitations is written on screen. The point of the game is to literally enter the realm of unknown and completely black out all safety factors of visually viewing the initial land you start upon. Using various ways, your returning it to visual draw and reaching the center again suggests your score, whether you clock what you think is a easy win, exiting yourself, or impress the complete madness of the random boundary size and complete it. Aside from using option zero to forfeit, the only other conclusion is to exit the program only to return.</Char_Desc_2000>
		</English>
	</Program_Descriptions>
	<Web_Info>
		<Application_URLs>
			<Application_Info_URL>Blacklawn.htm</Application_Info_URL>
			<Application_Order_URL />
			<Application_Screenshot_URL>Blacklawn.png</Application_Screenshot_URL>
			<Application_Icon_URL>Blacklawn32.png</Application_Icon_URL>
			<Application_XML_File_URL>Blacklawn.xml</Application_XML_File_URL>
		</Application_URLs>
		<Download_URLs>
			<Primary_Download_URL>http://www.neotext.org/ipub/apps/binary/Blacklawn%20v1.1.0.exe</Primary_Download_URL>
