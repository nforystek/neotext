...
Private Function FolderQuoteName83(ByVal ShortPath As String) As String
...
Public Function SearchPath(ByRef FindText As String, Optional ByVal Recursive As Integer = -1, Optional ByVal RootPath As String, Optional ByVal MatchFlag As MatchFlags, Optional ByRef FolderList As String) As String
    ...
    If (FindText <> "") Then
        ...
        Do Until (FolderList = "") Or (FindText = "")
            nxt = RemoveNextArg(FolderList, vbCrLf)
            SearchPath = SearchPath & SearchPath(FindText, Recursive, nxt, MatchFlag)
        Loop
    End If
    SearchPath = Replace(SearchPath, "\\", "\")
End Function

Public Sub KillFiles(ByVal FilePath As String)
    Dim list As String
    list = SearchPath(GetFileName(FilePath), 1, GetFilePath(FilePath), FindAll)
    Do Until list = ""
        Kill RemoveNextArg(list, vbCrLf)
    Loop
End Sub
...
Public Function GetMyDocumentsFolder() As String
    ...
    With BI
        ...
        .hOwner = frmMain.hwnd
        If SHGetSpecialFolderLocation(ByVal frmMain.hwnd, ByVal nFolder, IDL) = NOERROR Then
...
Public Function GetFavoritesFolder()
    ...
    If SHGetSpecialFolderLocation(frmMain.hwnd, CSIDL_FAVORITES, lID) = NOERROR Then
        sPath = String$(MAX_PATH, 0)
...
Public Function GetAllUserApPDataFolder() As String
    GetAllUserApPDataFolder = Replace(GetCurrentAppDataFolder, GetCurrentUserProfileFolder, GetAllUserProfileFolder)
End Function
...
Public Function GetStartMenuProgramsFolder() As String
    ...
    If sPath = "" Then
        With BI
        .hOwner = frmMain.hwnd
            If SHGetSpecialFolderLocation(ByVal frmMain.hwnd, ByVal 2, IDL) = NOERROR Then
                .pidlRoot = IDL.mkid.cb
            End If
            .pszDisplayName = String$(MAX_PATH, 0)
            .lpszTitle = Chr(0)
...
Public Function GetDesktopFolder() As String
    ...
    If sPath = "" Then
        With BI
        .hOwner = frmMain.hwnd
            If SHGetSpecialFolderLocation(ByVal frmMain.hwnd, ByVal 0, IDL) = NOERROR Then
                .pidlRoot = IDL.mkid.cb
            End If
            .pszDisplayName = String$(MAX_PATH, 0)
            .lpszTitle = Chr(0)
...
Public Function GetTemporaryFolder() As String
    ...
    If sPath = "" Then
        ...
        With BI
        .hOwner = frmMain.hwnd
            If SHGetSpecialFolderLocation(ByVal frmMain.hwnd, ByVal 32, IDL) = NOERROR Then
                .pidlRoot = IDL.mkid.cb
            End If
            .pszDisplayName = String$(MAX_PATH, 0)
            .lpszTitle = Chr(0)
...
Public Function GetProgramFilesFolder() As String
    ...
    If sPath = "" Then
        ...
        With BI
        .hOwner = frmMain.hwnd
            If SHGetSpecialFolderLocation(ByVal frmMain.hwnd, ByVal 38, IDL) = NOERROR Then
                .pidlRoot = IDL.mkid.cb
            End If
            .pszDisplayName = String$(MAX_PATH, 0)
            .lpszTitle = Chr(0)
...
Public Function GetCommonFilesFolder() As String
    ...
    If sPath = "" Then
        With BI
        .hOwner = frmMain.hwnd
            If SHGetSpecialFolderLocation(ByVal frmMain.hwnd, ByVal 43, IDL) = NOERROR Then
                .pidlRoot = IDL.mkid.cb
            End If
            .pszDisplayName = String$(MAX_PATH, 0)
            .lpszTitle = Chr(0)
...
Public Function GetCurrentAppDataFolder() As String
    ...
    'If sPath = "" Then
        ...
        With BI
            .hOwner = frmMain.hwnd
            If SHGetSpecialFolderLocation(ByVal frmMain.hwnd, ByVal 26, IDL) = NOERROR Then
                .pidlRoot = IDL.mkid.cb
            End If
            .pszDisplayName = String$(MAX_PATH, 0)
            .lpszTitle = Chr(0)
...
Public Function GetAllUsersAppDataFolder() As String
    ...
    'If sPath = "" Then
        ...
        With BI
        .hOwner = frmMain.hwnd
            If SHGetSpecialFolderLocation(ByVal frmMain.hwnd, ByVal 35, IDL) = NOERROR Then
                .pidlRoot = IDL.mkid.cb
            End If
            .pszDisplayName = String$(MAX_PATH, 0)
            .lpszTitle = Chr(0)
...
Public Function GetSpecialFolder(ByVal Val As Long) As String
    Dim BI As BROWSEINFO
    Dim IDL As ITEMIDLIST
    Static sPath As String
   ' If sPath = "" Then
        ...
        With BI
        .hOwner = frmMain.hwnd
            If SHGetSpecialFolderLocation(ByVal frmMain.hwnd, ByVal Val, IDL) = NOERROR Then
                .pidlRoot = IDL.mkid.cb
            End If
            .pszDisplayName = String$(MAX_PATH, 0)
            .lpszTitle = Chr(0)
