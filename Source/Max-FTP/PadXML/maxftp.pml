...
<PADGEN_PML>
	...
	<CompanyName />
	<Program_Info>
		<Program_Name>Max-FTP</Program_Name>
		<Program_Version>6.1.0</Program_Version>
		...
		<Program_OS_Support>Win2000,WinXP</Program_OS_Support>
		<Program_Language>English</Program_Language>
		<Program_Change_Info>no registration required</Program_Change_Info>
		<Program_Specific_Category>Internet</Program_Specific_Category>
		<Program_Category_Class>Network &amp; Internet::FTP Clients</Program_Category_Class>
		<Program_System_Requirements>300MHz, 64MB RAM</Program_System_Requirements>
		<File_Info>
			<File_Size_Bytes>8035664</File_Size_Bytes><File_Size_K>8035</File_Size_K><File_Size_MB>8.0</File_Size_MB>
		</File_Info>
		<Expire_Info>
	...
	<Program_Descriptions>
		<English>
			<Keywords>ftp, max-ftp, maxftp, max ftp, client, download, upload, freeware, file, transfer, max, protocol, neotext, open source, scheduling, scripting, Access</Keywords>
			<Char_Desc_45>A file transfer protocol client.</Char_Desc_45>
			<Char_Desc_80>A file transfer protocol client.  Transfers over 2GB supported.</Char_Desc_80>
			<Char_Desc_250>A file transfer protocol client.  Transfers over 2GB supported.  Designed as an enterprise solution it's robust in network support for Windows technology.  Performs file actions over MSN networks, FTP and local drives in any order.</Char_Desc_250>
			<Char_Desc_450>A file transfer protocol client.  Transfers over 2GB supported.  Designed as an enterprise solution it's robust in network support for Windows technology.  Performs file actions over MSN networks, FTP and local drives in any order.  Features include: scheduling as a Windows service, favorites, and easy URL addressing.  Being basic among the File Transfer Protocol gives it an interface that is user friendly.</Char_Desc_450>
			<Char_Desc_2000>A file transfer protocol client.  Transfers over 2GB supported.  Designed as an enterprise solution it's robust in network support for Windows technology.  Performs file actions over MSN networks, FTP and local drives in any order.  Features include: scheduling as a Windows service, favorites, and easy URL addressing.  Being basic among the File Transfer Protocol gives it an interface that is user friendly but it is also multi-user aware with security instinct for shared and public computer situations and Windows accounts.</Char_Desc_2000>
		</English>
	</Program_Descriptions>
	<Web_Info>
		<Application_URLs>
			<Application_Info_URL>maxftp.htm</Application_Info_URL>
			<Application_Order_URL />
			<Application_Screenshot_URL>maxftp.png</Application_Screenshot_URL>
			<Application_Icon_URL>maxftp32.png</Application_Icon_URL>
			<Application_XML_File_URL>maxftp.xml</Application_XML_File_URL>
		</Application_URLs>
		<Download_URLs>
			<Primary_Download_URL>http://www.neotext.org/ipub/apps/binary/Max-FTP%20v6.1.0-68367285.exe</Primary_Download_URL>
	...
	<Permissions>
		<Distribution_Permissions>Distribute as Freeware Open Source.</Distribution_Permissions>
