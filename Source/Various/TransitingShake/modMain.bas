...
Public Sub Main()
    ...
    Debug.Print "Server2 Checksum " & IIf(server2.Checksum(server.Para, server2.Seed), "Success", "Failure")
    ...
    Debug.Print "Server2 Checksum " & IIf(server2.Checksum(server2.Para, client.Seed), "Success", "Failure")
    Debug.Print "Client2 Checksum " & IIf(client2.Checksum(client2.Para, server.Seed), "Success", "Failure")
