...
'    VisibleRange.StartPos = SendMessageStruct(txtScript.hwnd, EM_CHARFROMPOS, 0&, pt)
'
'    pt.X = SendMessageLngPtr(txtScript.hwnd, EM_LINEFROMCHAR, VisibleRange.StartPos, 0&)
'   VisibleRange.StartPos = SendMessageLngPtr(txtScript.hwnd, EM_LINEINDEX, pt.X, 0&)
'
